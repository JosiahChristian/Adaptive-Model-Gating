...
from experiment_051 import CELLS,STRATEGIES,run_experiment_051_strategy
from run_experiment_051 import SEEDS,AUDIT,summary,write_csv,calibration_values
 ...
 with (out/'audit.jsonl').open('w',encoding='utf-8') as af:
  for seed in SEEDS:
   for st in STRATEGIES:
    rows=run_experiment_051_strategy(seed,c,st,vals);summ.append(summary(rows,c))
    if seed in AUDIT:
