...
from experiment_040 import CELLS
from run_experiment_040 import report_from,write_csv
def read_csv(p):
...
def main():
 ...
 if len(summ)!=112000 or len(post)!=80000 or audit_count!=504000:raise AssertionError((len(summ),len(post),audit_count))
