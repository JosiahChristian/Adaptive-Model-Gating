...
def main():
    assert e.OPERATIVE_SPEC_ISSUE==196
    ...
    assert base.OPERATIVE_SPEC_ISSUE==196
    print('Experiment 056 prospective replication smoke passed; Experiment 055 architecture and exact null cutoff preserved.')
