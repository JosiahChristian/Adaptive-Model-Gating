...
def main():
    assert e.OPERATIVE_SPEC_ISSUE==215
    ...
    assert base.OPERATIVE_SPEC_ISSUE==215
    print('Experiment 059 prospective confirmatory-replication smoke passed; Experiment 055/056 architecture and exact null cutoff preserved.')
