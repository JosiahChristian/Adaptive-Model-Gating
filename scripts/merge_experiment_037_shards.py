...
from experiment_037 import CELLS
from run_experiment_037 import report_from,write_csv
...
def main():
 ...
 if len(summ)!=64000 or len(post)!=80000 or audit_count!=288000:raise AssertionError((len(summ),len(post),audit_count))
