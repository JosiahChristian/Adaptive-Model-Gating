...
from experiment_036 import CELLS
from run_experiment_036 import report_from,write_csv
def read_csv(p):
...
def main():
 ...
 if len(summ)!=48000 or len(post)!=80000 or audit_count!=216000:raise AssertionError((len(summ),len(post),audit_count))
