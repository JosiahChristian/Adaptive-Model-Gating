...
from experiment_044 import CELLS
from run_experiment_044 import report_from,write_csv
...
def main():
 ...
 if len(summ)!=160000 or len(post)!=80000 or audit_count!=720000:raise AssertionError((len(summ),len(post),audit_count))
