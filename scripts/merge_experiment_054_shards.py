...
from run_experiment_054 import CELLS,STRATEGIES,SEEDS,AUDIT,report_from,write_csv
 ...
 for p in paths:
  with p.open(encoding='utf-8') as f:
   for line in f:
    ...
    r=json.loads(line);row_count+=1;key=(str(r.get('experiment054_cell','')),int(r['seed']),str(r['strategy']))
