...
from experiment_038 import CELLS
from run_experiment_038 import report_from,write_csv
...
def main():
 ...
 if len(summ)!=80000 or len(post)!=80000 or audit_count!=360000:raise AssertionError((len(summ),len(post),audit_count))
