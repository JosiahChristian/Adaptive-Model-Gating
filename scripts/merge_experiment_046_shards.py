...
from experiment_046 import CELLS
from run_experiment_046 import report_from,write_csv
def read_csv(p):
...
def main():
 ...
 if len(summ)!=192000 or audit_count!=864000:raise AssertionError((len(summ),audit_count))
