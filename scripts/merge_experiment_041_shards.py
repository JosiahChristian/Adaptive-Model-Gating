...
from experiment_041 import CELLS
from run_experiment_041 import report_from,write_csv
...
def main():
 ...
 if len(summ)!=128000 or len(post)!=80000 or audit_count!=576000:raise AssertionError((len(summ),len(post),audit_count))
