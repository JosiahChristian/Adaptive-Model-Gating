...
from experiment_029 import ACCEPT_THRESHOLD,TRIAD,infer_posterior_risk
from experiment_032 import COMPOSED_STRATEGY
from experiment_043 import CELLS,STRATEGIES,REPLICATED_GAUSSIAN_STRATEGY,CONFIRMATIONS_REQUIRED,generate_experiment_043_stream,infer_replicated_gaussian,run_experiment_043_strategy,evaluate_gaussian_posterior
from run_experiment_021 import calibrations

def main():
 if CONFIRMATIONS_REQUIRED!=2 or ACCEPT_THRESHOLD!=.99 or len(STRATEGIES)!=9:raise AssertionError((CONFIRMATIONS_REQUIRED,ACCEPT_THRESHOLD,len(STRATEGIES)))
