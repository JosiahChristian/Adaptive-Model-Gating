...
from experiment_045 import CELLS,STRATEGIES,run_experiment_045_strategy
from run_experiment_045 import SEEDS,AUDIT,summary,write_csv,calibration_values
def main():
 ...
 with (out/'audit.jsonl').open('w',encoding='utf-8') as af:
  for seed in SEEDS:
   for st in STRATEGIES:
    rows=run_experiment_045_strategy(seed,c,st,vals);summ.append(summary(rows,c))
    if seed in AUDIT:
