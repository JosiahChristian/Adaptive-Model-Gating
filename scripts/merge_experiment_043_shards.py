...
from experiment_043 import CELLS
from run_experiment_043 import report_from,write_csv
...
def main():
 ...
 if len(summ)!=144000 or len(post)!=80000 or audit_count!=648000:raise AssertionError((len(summ),len(post),audit_count))
